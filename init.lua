--[[
-- video describing how to use this file
...
require('nvim-treesitter.configs').setup {
  ...
  -- ensure_installed = { 'go', 'javascript', 'lua', 'markdown', 'python', 'ruby', 'tsx', 'typescript', 'vim' },
  ensure_installed = { 'go', 'javascript', 'lua', 'markdown', 'python', 'tsx', 'typescript', 'vim' },
...
-- START https://github.com/neovim/nvim-lspconfig
-- Global mappings.
...
-- END https://github.com/neovim/nvim-lspconfig
